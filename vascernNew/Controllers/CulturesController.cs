...
namespace vascernNew.Controllers
{
    public class CulturesController : Controller
    {
        ...
        public CulturesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Culture culture)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Culture culture)
        {
            if (id != culture.Id)
            {
                return NotFound();
